execute if score debug_instructions cbc_settings matches 1 run tellraw @a "STORE R1 ADDR R2"
...
#Set value
data modify storage cb_computer:storage tmp_mem[0] set from storage cb_computer:storage Registers[0]
