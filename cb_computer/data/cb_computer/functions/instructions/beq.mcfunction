execute if score debug_instructions cbc_settings matches 1 run tellraw @a "BEQ"
...
execute if score r1 cbc_tmp1 = r2 cbc_tmp1 run scoreboard players operation branch cbc = PC cbc
